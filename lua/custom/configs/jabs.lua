require("jabs").setup {
  ...
  split_filename_path_width = 50, -- If split_filename is true, how wide the column for the path is supposed to be, Default 0 (don't show path)
  ...
  keymap = {
    ...
    preview = "e", -- Open buffer preview. Default P
  },
